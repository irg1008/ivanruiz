...
const tables = [
	...
	},
	{
		name: 'Like',
		columns: [
			{ name: 'likedEntity', type: 'link', link: { table: 'Entity' } },
	...
	{
		name: 'Entity',
		columns: [{ name: 'like', type: 'link', link: { table: 'Like' }, unique: true }],
		revLinks: [
	...
	},
	{
		name: 'NodeLike',
		columns: [
			{ name: 'entity', type: 'link', link: { table: 'Entity' } },
...
const defaultOptions = {
	databaseURL: 'https://Iv-n-Ruiz-G-zquez-s-workspace-0ntic2.eu-west-1.xata.sh/db/ivanruiz',
}
